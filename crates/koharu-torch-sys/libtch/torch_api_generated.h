...
#ifndef __TORCH_API_GENERATED_H__
...
void atg__efficient_attention_backward(tensor *, tensor grad_out_, tensor query, tensor key, tensor value, tensor bias, tensor out, tensor cu_seqlens_q, tensor cu_seqlens_k, int64_t max_seqlen_q, int64_t max_seqlen_k, tensor logsumexp, double dropout_p, tensor philox_seed, tensor philox_offset, int64_t custom_mask_type, int bias_requires_grad, double scale_v, int8_t scale_null, int64_t num_splits_key_v, int8_t num_splits_key_null, int64_t window_size_v, int8_t window_size_null, int shared_storage_dqdkdv);
...
void atg__flash_attention_backward(tensor *, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, tensor rng_state, tensor unused, double scale_v, int8_t scale_null, int64_t window_size_left_v, int8_t window_size_left_null, int64_t window_size_right_v, int8_t window_size_right_null);
void atg__flash_attention_forward_no_dropout_inplace(tensor *, tensor out, tensor query, tensor key, tensor value, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, int return_debug_mask, double scale_v, int8_t scale_null, int64_t window_size_left_v, int8_t window_size_left_null, int64_t window_size_right_v, int8_t window_size_right_null, tensor seqused_k, tensor alibi_slopes, tensor block_table, int64_t num_splits_v, int8_t num_splits_null);
...
void atg__functional_sym_constrain_range(tensor *, scalar size, int64_t min_v, int8_t min_null, int64_t max_v, int8_t max_null, tensor dep_token);
void atg__functional_sym_constrain_range_for_size(tensor *, scalar size, int64_t min_v, int8_t min_null, int64_t max_v, int8_t max_null, tensor dep_token);
...
void atg__fused_rms_norm(tensor *, tensor input, int64_t *normalized_shape_data, int normalized_shape_len, tensor weight, double eps_v, int8_t eps_null);
int64_t atg__fused_sdp_choice(tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, double scale_v, int8_t scale_null, int enable_gqa);
...
void atg__masked_softmax(tensor *, tensor self, tensor mask, int64_t dim_v, int8_t dim_null, int64_t mask_type_v, int8_t mask_type_null);
void atg__masked_softmax_backward(tensor *, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int8_t dim_null);
void atg__masked_softmax_backward_out(tensor *, tensor out, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int8_t dim_null);
void atg__masked_softmax_out(tensor *, tensor out, tensor self, tensor mask, int64_t dim_v, int8_t dim_null, int64_t mask_type_v, int8_t mask_type_null);
...
void atg__native_multi_head_attention(tensor *, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights, int64_t mask_type_v, int8_t mask_type_null);
void atg__native_multi_head_attention_out(tensor *, tensor out0, tensor out1, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights, int64_t mask_type_v, int8_t mask_type_null);
...
void atg__nested_from_padded_tensor(tensor *, tensor padded, tensor offsets, tensor dummy, int64_t ragged_idx, tensor min_seqlen, tensor max_seqlen, int64_t sum_S_v, int8_t sum_S_null);
...
void atg__pad_enum(tensor *, tensor self, int64_t *pad_data, int pad_len, int64_t mode, double value_v, int8_t value_null);
...
void atg__scaled_dot_product_attention_math(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, int8_t scale_null, int enable_gqa);
void atg__scaled_dot_product_attention_math_for_mps(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, int8_t scale_null, int enable_gqa);
...
void atg__scaled_dot_product_efficient_attention(tensor *, tensor query, tensor key, tensor value, tensor attn_bias, int compute_log_sumexp, double dropout_p, int is_causal, double scale_v, int8_t scale_null);
void atg__scaled_dot_product_flash_attention_backward(tensor *, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, tensor philox_seed, tensor philox_offset, double scale_v, int8_t scale_null);
void atg__scaled_dot_product_flash_attention_for_cpu(tensor *, tensor query, tensor key, tensor value, double dropout_p, int is_causal, tensor attn_mask, double scale_v, int8_t scale_null);
void atg__scaled_dot_product_flash_attention_for_cpu_backward(tensor *, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, double dropout_p, int is_causal, tensor attn_mask, double scale_v, int8_t scale_null);
...
void atg__to_sparse(tensor *, tensor self, int8_t layout, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_bsc(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_bsc_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_bsr(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_bsr_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_csc(tensor *, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_csc_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_csr(tensor *, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_csr_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
void atg__to_sparse_out(tensor *, tensor out, tensor self, int8_t layout, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
...
void atg__transformer_encoder_layer_fwd(tensor *, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int8_t mask_type_null);
void atg__transformer_encoder_layer_fwd_out(tensor *, tensor out, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int8_t mask_type_null);
...
void atg__upsample_bicubic2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bicubic2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bicubic2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bicubic2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg__upsample_bilinear2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bilinear2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bilinear2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_bilinear2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg__upsample_lanczos2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_lanczos2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_lanczos2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_lanczos2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg__upsample_nearest_exact1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int8_t scales_null);
void atg__upsample_nearest_exact1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int8_t scales_null);
void atg__upsample_nearest_exact1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int8_t scales_null);
void atg__upsample_nearest_exact1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int8_t scales_null);
...
void atg__upsample_nearest_exact2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg__upsample_nearest_exact3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg__upsample_nearest_exact3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_aminmax(tensor *, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
void atg_aminmax_out(tensor *, tensor min, tensor max, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
...
void atg_argmax(tensor *, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
void atg_argmax_out(tensor *, tensor out, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
void atg_argmin(tensor *, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
void atg_argmin_out(tensor *, tensor out, tensor self, int64_t dim_v, int8_t dim_null, int keepdim);
...
void atg_as_strided(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
void atg_as_strided_(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
void atg_as_strided_copy(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
void atg_as_strided_copy_out(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
void atg_as_strided_scatter(tensor *, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
void atg_as_strided_scatter_out(tensor *, tensor out, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int8_t storage_offset_null);
...
void atg_avg_pool2d(tensor *, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool2d_backward(tensor *, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool2d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool3d(tensor *, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool3d_backward(tensor *, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
void atg_avg_pool3d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int8_t divisor_override_null);
...
void atg_cdist(tensor *, tensor x1, tensor x2, double p, int64_t compute_mode_v, int8_t compute_mode_null);
...
void atg_count_nonzero(tensor *, tensor self, int64_t dim_v, int8_t dim_null);
...
void atg_count_nonzero_out(tensor *, tensor out, tensor self, int64_t dim_v, int8_t dim_null);
void atg_cov(tensor *, tensor self, int64_t correction, tensor fweights, tensor aweights);
void atg_cross(tensor *, tensor self, tensor other, int64_t dim_v, int8_t dim_null);
...
void atg_cross_out(tensor *, tensor out, tensor self, tensor other, int64_t dim_v, int8_t dim_null);
...
void atg_embedding_bag_padding_idx(tensor *, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx_v, int8_t padding_idx_null);
...
void atg_fft_fft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_fft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_hfft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_hfft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_ifft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_ifft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_ihfft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_ihfft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_irfft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_irfft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_rfft(tensor *, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_fft_rfft_out(tensor *, tensor out, tensor self, int64_t n_v, int8_t n_null, int64_t dim, char* norm_ptr, int norm_len);
...
void atg_from_file(tensor *, char* filename_ptr, int filename_len, int shared, int64_t size_v, int8_t size_null, int options_kind, int options_device);
void atg_from_file_out(tensor *, tensor out, char* filename_ptr, int filename_len, int shared, int64_t size_v, int8_t size_null);
...
void atg_istft(tensor *, tensor self, int64_t n_fft, int64_t hop_length_v, int8_t hop_length_null, int64_t win_length_v, int8_t win_length_null, tensor window, int center, int normalized, int onesided, int64_t length_v, int8_t length_null, int return_complex);
...
void atg_linalg_lstsq(tensor *, tensor self, tensor b, double rcond_v, int8_t rcond_null, char* driver_ptr, int driver_len);
void atg_linalg_lstsq_out(tensor *, tensor solution, tensor residuals, tensor rank, tensor singular_values, tensor self, tensor b, double rcond_v, int8_t rcond_null, char* driver_ptr, int driver_len);
...
void atg_linalg_matrix_rank_atol_rtol_float(tensor *, tensor self, double atol_v, int8_t atol_null, double rtol_v, int8_t rtol_null, int hermitian);
void atg_linalg_matrix_rank_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol_v, int8_t atol_null, double rtol_v, int8_t rtol_null, int hermitian);
...
void atg_linalg_pinv_atol_rtol_float(tensor *, tensor self, double atol_v, int8_t atol_null, double rtol_v, int8_t rtol_null, int hermitian);
void atg_linalg_pinv_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol_v, int8_t atol_null, double rtol_v, int8_t rtol_null, int hermitian);
...
void atg_linalg_vander(tensor *, tensor x, int64_t n_v, int8_t n_null);
...
void atg_logit(tensor *, tensor self, double eps_v, int8_t eps_null);
void atg_logit_(tensor *, tensor self, double eps_v, int8_t eps_null);
void atg_logit_backward(tensor *, tensor grad_output, tensor self, double eps_v, int8_t eps_null);
void atg_logit_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, double eps_v, int8_t eps_null);
void atg_logit_out(tensor *, tensor out, tensor self, double eps_v, int8_t eps_null);
...
void atg_nan_to_num(tensor *, tensor self, double nan_v, int8_t nan_null, double posinf_v, int8_t posinf_null, double neginf_v, int8_t neginf_null);
void atg_nan_to_num_(tensor *, tensor self, double nan_v, int8_t nan_null, double posinf_v, int8_t posinf_null, double neginf_v, int8_t neginf_null);
void atg_nan_to_num_out(tensor *, tensor out, tensor self, double nan_v, int8_t nan_null, double posinf_v, int8_t posinf_null, double neginf_v, int8_t neginf_null);
...
void atg_nanquantile(tensor *, tensor self, tensor q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_nanquantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_nanquantile_scalar(tensor *, tensor self, double q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_nanquantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_pad(tensor *, tensor self, int64_t *pad_data, int pad_len, char* mode_ptr, int mode_len, double value_v, int8_t value_null);
...
void atg_quantile(tensor *, tensor self, tensor q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_quantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_quantile_scalar(tensor *, tensor self, double q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
void atg_quantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim_v, int8_t dim_null, int keepdim, char* interpolation_ptr, int interpolation_len);
...
void atg_random_from(tensor *, tensor self, int64_t from, int64_t to_v, int8_t to_null);
void atg_random_from_(tensor *, tensor self, int64_t from, int64_t to_v, int8_t to_null);
void atg_random_from_out(tensor *, tensor out, tensor self, int64_t from, int64_t to_v, int8_t to_null);
...
void atg_repeat_interleave(tensor *, tensor repeats, int64_t output_size_v, int8_t output_size_null);
void atg_repeat_interleave_self_int(tensor *, tensor self, int64_t repeats, int64_t dim_v, int8_t dim_null, int64_t output_size_v, int8_t output_size_null);
void atg_repeat_interleave_self_tensor(tensor *, tensor self, tensor repeats, int64_t dim_v, int8_t dim_null, int64_t output_size_v, int8_t output_size_null);
void atg_repeat_interleave_tensor_out(tensor *, tensor out, tensor repeats, int64_t output_size_v, int8_t output_size_null);
...
void atg_rms_norm(tensor *, tensor input, int64_t *normalized_shape_data, int normalized_shape_len, tensor weight, double eps_v, int8_t eps_null);
...
void atg_scaled_dot_product_attention(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, double scale_v, int8_t scale_null, int enable_gqa);
...
void atg_slice(tensor *, tensor self, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
...
void atg_slice_copy(tensor *, tensor self, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
void atg_slice_copy_tensor_out(tensor *, tensor out, tensor self, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
void atg_slice_inverse(tensor *, tensor self, tensor src, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
void atg_slice_scatter(tensor *, tensor self, tensor src, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
void atg_slice_scatter_out(tensor *, tensor out, tensor self, tensor src, int64_t dim, int64_t start_v, int8_t start_null, int64_t end_v, int8_t end_null, int64_t step);
...
void atg_special_logit(tensor *, tensor self, double eps_v, int8_t eps_null);
void atg_special_logit_out(tensor *, tensor out, tensor self, double eps_v, int8_t eps_null);
...
void atg_stft(tensor *, tensor self, int64_t n_fft, int64_t hop_length_v, int8_t hop_length_null, int64_t win_length_v, int8_t win_length_null, tensor window, int normalized, int onesided, int return_complex, int align_to_window);
void atg_stft_center(tensor *, tensor self, int64_t n_fft, int64_t hop_length_v, int8_t hop_length_null, int64_t win_length_v, int8_t win_length_null, tensor window, int center, char* pad_mode_ptr, int pad_mode_len, int normalized, int onesided, int return_complex, int align_to_window);
...
void atg_take_along_dim(tensor *, tensor self, tensor indices, int64_t dim_v, int8_t dim_null);
void atg_take_along_dim_out(tensor *, tensor out, tensor self, tensor indices, int64_t dim_v, int8_t dim_null);
...
void atg_to_sparse(tensor *, tensor self, int8_t layout, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg_to_sparse_bsc(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg_to_sparse_bsr(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int8_t dense_dim_null);
void atg_to_sparse_csc(tensor *, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
void atg_to_sparse_csr(tensor *, tensor self, int64_t dense_dim_v, int8_t dense_dim_null);
...
void atg_unique_consecutive(tensor *, tensor self, int return_inverse, int return_counts, int64_t dim_v, int8_t dim_null);
void atg_unique_consecutive_out(tensor *, tensor out0, tensor out1, tensor out2, tensor self, int return_inverse, int return_counts, int64_t dim_v, int8_t dim_null);
...
void atg_upsample_bicubic2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bicubic2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bicubic2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bicubic2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_upsample_bilinear2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bilinear2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bilinear2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_bilinear2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_upsample_linear1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int8_t scales_null);
void atg_upsample_linear1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int8_t scales_null);
void atg_upsample_linear1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int8_t scales_null);
void atg_upsample_linear1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int8_t scales_null);
...
void atg_upsample_nearest1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int8_t scales_null);
void atg_upsample_nearest1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int8_t scales_null);
void atg_upsample_nearest1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int8_t scales_null);
void atg_upsample_nearest1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int8_t scales_null);
...
void atg_upsample_nearest2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_upsample_nearest3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_nearest3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_upsample_trilinear3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_trilinear3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_trilinear3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
void atg_upsample_trilinear3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int8_t scales_d_null, double scales_h_v, int8_t scales_h_null, double scales_w_v, int8_t scales_w_null);
...
void atg_vander(tensor *, tensor x, int64_t n_v, int8_t n_null, int increasing);
