...
impl LlamaContext<'_> {
    ...
    pub fn copy_cache(&mut self, src: i32, dest: i32, size: i32) {
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_cp(mem, src, dest, 0, size) }
    }
    ...
    pub fn copy_kv_cache_seq(
        ...
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_cp(mem, src, dest, p0, p1) };
        Ok(())
    }
    ...
    pub fn clear_kv_cache_seq(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        Ok(unsafe { koharu_llama_sys::llama_memory_seq_rm(mem, src, p0, p1) })
    }
    ...
    pub fn clear_kv_cache(&mut self) {
        ...
        unsafe { koharu_llama_sys::llama_memory_clear(mem, true) }
    }
    ...
    pub fn llama_kv_cache_seq_keep(&mut self, seq_id: i32) {
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_keep(mem, seq_id) }
    }
    ...
    pub fn kv_cache_seq_cp(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_cp(mem, seq_id_src, seq_id_dst, p0, p1) };
        Ok(())
    }
    ...
    pub fn kv_cache_seq_add(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_add(mem, seq_id, p0, p1, delta) };
        Ok(())
    }
    ...
    pub fn kv_cache_seq_rm(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        if !unsafe { koharu_llama_sys::llama_memory_seq_rm(mem, seq_id, p0, p1) } {
    ...
    pub fn kv_cache_seq_div(
        ...
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_div(mem, seq_id, p0, p1, d) }
        Ok(())
    }
    ...
    pub fn kv_cache_seq_pos_min(&self, seq_id: i32) -> i32 {
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_pos_min(mem, seq_id) }
    }
    ...
    pub fn kv_cache_seq_pos_max(&self, seq_id: i32) -> i32 {
        let mem = unsafe { koharu_llama_sys::llama_get_memory(self.context.as_ptr()) };
        unsafe { koharu_llama_sys::llama_memory_seq_pos_max(mem, seq_id) }
    }
}
